    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="#contact">Contact- login</a></li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>login</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i>	<a href="?controller=welcome&method=Registro">Registrarse</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="?controller=welcome&method=login">Iniciar sesión</a></li>
            </ul>
          </div>
